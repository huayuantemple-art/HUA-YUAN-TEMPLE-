...
後台 SHALL 提供與現有 `admin.html` 完全相同的管理模組:總覽 dashboard、公告管理、課程管理、報名資料、法師說法管理、佛法文檔管理、關於我們、聯絡與交通。每個模組的欄位、操作(新增/編輯/刪除/發布狀態切換)、版面與互動 MUST 與現有實作一致,行為 MUST NOT 增減或改變。
